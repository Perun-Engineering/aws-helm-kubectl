...
ARG ALPINE_VERSION=3.24.0
ARG AWS_CLI_VERSION=2.35.4
ARG KUBE_VERSION=1.36.2
ARG HELM_VERSION=4.2.1
ARG SOPS_VERSION=3.13.1
ARG HELM_SECRETS_VERSION=4.7.7
ARG HELM_S3_VERSION=0.17.2
ARG HELMFILE_VERSION=1.5.3
ARG HELM_DIFF_VERSION=3.15.8
ARG TARGETOS
ARG TARGETARCH
